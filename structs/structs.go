/*
Go structs are typed collections of fields. They're useful for grouping data together to form records.
*/
...
func main() {
    ...
    fmt.Println(&person{name: "Ann", age: 40})
		...
		// It's idiomatic tot encapsulate new struct creation in constructor functions
